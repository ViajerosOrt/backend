...
export class  $npmConfigName1732830423285 implements MigrationInterface {
    name = ' $npmConfigName1732830423285'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "review" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "stars" character varying NOT NULL, "content" character varying NOT NULL, "create_user_id" uuid, "received_user_id" uuid, "travel_id" uuid, CONSTRAINT "PK_2e4299a343a81574217255c00ca" PRIMARY KEY ("id"))`);
