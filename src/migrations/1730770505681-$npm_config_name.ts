...
export class  $npmConfigName1730770505681 implements MigrationInterface {
    name = ' $npmConfigName1730770505681'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE IF NOT EXISTS "item" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "is_endable" boolean NOT NULL DEFAULT false, "checklist_id" uuid, "user_id" uuid, CONSTRAINT "PK_d3c0c71f23e7adcf952a1d13423" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE IF NOT EXISTS "activity" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "activity_name" character varying NOT NULL, CONSTRAINT "PK_24625a1d6b1b089c8ae206fe467" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE IF NOT EXISTS "users_user_activities_activity" ("usersId" uuid NOT NULL, "activityId" uuid NOT NULL, CONSTRAINT "PK_8a5db26e7c0d973678ee76b9a77" PRIMARY KEY ("usersId", "activityId"))`);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_1c5790d904f7fe29d31c2b2cd2" ON "users_user_activities_activity" ("usersId") `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_c3e61b93d294ce363395a19175" ON "users_user_activities_activity" ("activityId") `);
        await queryRunner.query(`CREATE TABLE IF NOT EXISTS "users_joins_travels_travel" ("usersId" uuid NOT NULL, "travelId" uuid NOT NULL, CONSTRAINT "PK_05ae89783f0e01445570b0cf01b" PRIMARY KEY ("usersId", "travelId"))`);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_ad376a856fc93c24603e464375" ON "users_joins_travels_travel" ("usersId") `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_f84ecb8a66d483576f6feebf3e" ON "users_joins_travels_travel" ("travelId") `);
        await queryRunner.query(`CREATE TABLE IF NOT EXISTS "travel_travel_activities_activity" ("travelId" uuid NOT NULL, "activityId" uuid NOT NULL, CONSTRAINT "PK_77aeff68a9e434c7ae3a8b2ff87" PRIMARY KEY ("travelId", "activityId"))`);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_60c9ee0c1136071f842a62edbb" ON "travel_travel_activities_activity" ("travelId") `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_bb99c4358225ebd612e4faad08" ON "travel_travel_activities_activity" ("activityId") `);
